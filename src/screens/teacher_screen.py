...
from src.database.db import check_teacher_exists, create_teacher,teacher_login,get_teacher_subjects,get_attendence_for_teachers
...
def teacher_tab_attendence_records():
    ...
    teacher_id= st.session_state.teacher_data['teacher_id']
    records= get_attendence_for_teachers(teacher_id)
    if not records:
        return
    data=[]
    for r in records:
...
def teacher_screen_login():
    ...
    st.space()
    teacher_username= st.text_input("Enter Username", placeholder='aratidas')
    teacher_password= st.text_input("Enter Password", placeholder='1233456')
...
def teacher_screen_register():
    ...
    st.space()
    teacher_username= st.text_input("Enter Username", placeholder='aratidas')
    teacher_name= st.text_input("Enter Name", placeholder='Arati Das')
    teacher_password= st.text_input("Enter Password", placeholder='1233456')
    teacher_password_confirm= st.text_input("Enter Confirm Password", placeholder='1233456')
    btnc1,btnc2= st.columns(2)
    with btnc1:
